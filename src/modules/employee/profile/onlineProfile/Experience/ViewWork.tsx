            ...
            {listOfWork?.map((work) =>
                <Box key={work.id} display="flex" columnGap={2} my={2}>
                    ...
                    <Box display='flex' flexDirection='column' rowGap='3px' flex={1}>
                        ...
                        <Typography fontSize={12}>{work.startDate} - {(work.endDate && work.endDate !== "1899-11-30") ? work.endDate : "Hiện tại"}</Typography>
                        <Box display="flex">
            ...
            }
            {
                ...
                (<>
                    <Typography fontSize={12} color={"grey.600"}>
                        <em>Mô tả kinh nghiệm làm việc của bạn càng chi tiết càng tốt, điều đó giúp bạn có cơ hội được tuyển dụng cao hơn </em>
                    </Typography>
                    <Divider />
                    <Button
                        variant="text"
