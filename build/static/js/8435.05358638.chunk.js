  ...
  [8435],
  {
    ...
    68069: (e, o, t) => {
      ...
      var y = t(19290),
        ...
        E = t(33173),
        I = t(62954);
      const T = (0, t(45903).A)('input')({ display: 'none' }),
        V = (e) => {
          let { isLoading: o, handleUploadFile: t } = e;
          const { control: i } = (0, O.mN)({});
          return (0, j.jsx)(s.A, {
            children: (0, j.jsxs)(c.A, {
              component: 'label',
              startIcon: (0, j.jsx)(I.A, {}),
              variant: 'outlined',
              color: 'secondary',
              disabled: o,
              children: [
                (0, j.jsx)(E.A, {
                  element: (0, j.jsx)(T, { type: 'file', accept: '.pdf' }),
                  control: i,
                  name: 'CV',
                  id: 'CV',
      ...
      const R = w.BZ.acceptTypes,
        _ = w.BZ.acceptSize,
        H = w.BZ.acceptSize / 1024 / 1024,
        M = (e) => {
          const { id: o } = e,
            [t, n] = (0, i.useState)(!1),
            [x, v] = (0, i.useState)(!1),
            ...
            { profile: J } = (0, k.A)(),
            { profile: K } = (0, C.A)(),
            Q = (e) => R.includes(e.type) && e.size <= _,
            X = async (e) => {
              v(!1), w(!1), n(!0);
          ...
          return (
            ...
            (0, i.useEffect)(() => {
              const e = (0, B.Z)(E, JSON.stringify(N));
              L(e), Z(!1);
            ...
            (0, j.jsxs)(s.A, {
              ...
              children: [
                (0, j.jsxs)(p.A, {
                  ...
                  children: [
                    ...
                    (0, j.jsxs)(s.A, {
                      py: 2,
                      children: [
                        (0, j.jsx)(W, { id: o, profile: M, uploadedCV: S }),
                        'upload-cv' === o &&
                          S.url &&
                          (0, j.jsxs)(s.A, {
                            display: 'flex',
                          ...
                          children: [
                            (0, j.jsx)(c.A, {
                              ...
                              onClick: async () => {
                                ...
                                if (
                                  'upload-cv' !== o &&
                                  (null === M || void 0 === M || !M.userId)
                                )
                                  return;
                                if (null !== M && void 0 !== M && M.keywords)
                                  return void L(
                                    null === M || void 0 === M
                                      ? void 0
                                      : M.keywords
                                ...
                                if ((Z(!0), 'upload-cv' === o)) {
                                  const e = await (0, U.A)(y.uz, N, null, {
                                    58: 5,
                                    60: 5
                                  });
                                  return void I(e);
                                ...
                                if ('document' === o)
                                  ...
                                  Y(() => [t]);
                                  const e = await (0, U.A)(y.uz, [t], null, {
                                    58: 5,
                                    60: 5
                                  });
                                  I([...i, ...e]);
                        ...
                        'upload-cv' === o &&
                          (0, j.jsx)(F.A, { acceptTypes: R, acceptSize_MB: H }),
                ...
                T && (0, j.jsx)(A, { id: o, profile: M || { keywords: T } })
              ]
            })
          );
        },
        P = () =>
          (0, j.jsxs)(n.A, {
            ...
            children: [
              (0, j.jsx)(M, { id: 'online' }),
              (0, j.jsx)(M, { id: 'document' }),
              (0, j.jsx)(M, { id: 'upload-cv' })
            ]
          });
    },
    78910: (e, o, t) => {
...
//# sourceMappingURL=8435.05358638.chunk.js.map
