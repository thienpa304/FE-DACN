  ...
  [9408],
  {
    ...
    48267: (e, t, s) => {
      ...
      function r() {
        ...
        const { baseClasses: t, newClasses: s, Component: a } = e;
        if (!s) return t;
        const n = (0, c.A)({}, t);
        return (
      ...
      const o = {
        set: (e, t, s, a) => {
          let c = e.get(t);
          c || ((c = new Map()), e.set(t, c)), c.set(s, a);
        },
        get: (e, t, s) => {
          const a = e.get(t);
        ...
        return {
          create: (s, n) => {
            ...
            if (
              ...
              return l;
            const r = s.components[n].styleOverrides || {},
              o = s.components[n].variants || [],
              h = (0, c.A)({}, l);
            return (
                        ...
                        c +=
                          'color' === t
                            ? m(c)
                              ...
                              : (0, d.A)(e[t])
                            : ''
                                .concat(m(c) ? t : (0, d.A)(t))
                                .concat((0, d.A)(e[t].toString()));
                      }),
                    c
                  );
                })(e.props);
                h[t] = (0, u.A)(h[t] || {}, e.style);
              }),
              h
            );
          },
      ...
      const C = {},
        y = ['name', 'classNamePrefix', 'Component', 'defaultTheme'];
      function A(e) {
        let t =
        ...
        return function () {
          ...
          !(function (e, t) {
            ...
            return (
              (function (e, t) {
                ...
                let v = o.get(n.sheetsManager, h, a);
                v ||
                  ((v = { refs: 0, staticSheet: null, dynamicStyles: null }),
                  o.set(n.sheetsManager, h, a, v));
                const u = (0, c.A)({}, h.options, n, {
                  theme: a,
                  flip:
                    'boolean' === typeof n.flip ? n.flip : 'rtl' === a.direction
                });
                u.generateId = u.serverGenerateClassName || u.generateClassName;
                const d = n.sheetsRegistry;
                if (0 === v.refs) {
                  let e;
                  n.sheetsCache && (e = o.get(n.sheetsCache, h, a));
                  const t = h.create(a, i);
                  e ||
                    ((e = n.jss.createStyleSheet(t, (0, c.A)({ link: !1 }, u))),
                    e.attach(),
                    n.sheetsCache && o.set(n.sheetsCache, h, a, e)),
                    d && d.add(e),
                    (v.staticSheet = e),
                    (v.dynamicStyles = (0, l.ih)(t));
                }
                if (v.dynamicStyles) {
                  ...
                  e.update(t),
                    ...
                    d && d.add(e);
                } else s.classes = v.staticSheet.classes;
                v.refs += 1;
              })(n, e),
              (u.current = !1),
              (v.current = n),
              () => {
                !(function (e) {
                  ...
                  if (a.disableGeneration) return;
                  const n = o.get(a.sheetsManager, c, s);
                  n.refs -= 1;
                  const l = a.sheetsRegistry;
                  0 === n.refs &&
                    (o.delete(a.sheetsManager, c, s),
                    a.jss.removeStyleSheet(n.staticSheet),
                    l && l.remove(n.staticSheet)),
                    t.dynamicSheet &&
                      (a.jss.removeStyleSheet(t.dynamicSheet),
                      l && l.remove(t.dynamicSheet));
                })(n);
              }
            );
          }, [t, A]),
          ...
          const p = (function (e, t, s) {
            let { state: a, stylesOptions: c } = e;
            if (c.disableGeneration) return t || {};
            a.cacheClasses ||
              (a.cacheClasses = { value: null, lastProp: null, lastJSS: {} });
            let n = !1;
            return (
              a.classes !== a.cacheClasses.lastJSS &&
                ((a.cacheClasses.lastJSS = a.classes), (n = !0)),
              t !== a.cacheClasses.lastProp &&
                ((a.cacheClasses.lastProp = t), (n = !0)),
              n &&
                (a.cacheClasses.value = r({
...
//# sourceMappingURL=9408.9cfbc986.chunk.js.map
