...
(self.webpackChunkFE_DACN = self.webpackChunkFE_DACN || []).push([
  [8388],
  {
    ...
    64188: (e, o, i) => {
      ...
      const k = function (e) {
        const {
          ...
          { totalResults: m, refetch: g } = (0, z.A)({ ...u }),
          f = d || 15,
          j = Math.ceil(m / f),
          { jobs: y, refetch: k } = a({ page: p, num: f, ...u });
        return (
          (0, l.useEffect)(() => {
            k(), g();
          }, [u]),
    ...
    38388: (e, o, i) => {
      ...
      const d = function () {
        var e;
        const { state: o, pathname: i } = (0, s.zy)(),
          { id: d } = (0, s.g)(),
          x =
            null === (e = n.AJ.find((e) => (0, r.O)(e.name) === d)) ||
            void 0 === e
              ? void 0
              : e.name;
        console.log(x);
        ...
        return (
          console.log(v),
          (0, c.jsx)(t.A, {
            pageTitle: 'Vi\u1ec7c l\xe0m: '.concat(v || x),
            profession: x,
            jobTitle: v,
            queryJobs: l.A
          })
...
//# sourceMappingURL=8388.c1546453.chunk.js.map
