  ...
  [9225],
  {
    80881: (e, n, i) => {
      ...
      var o = i(19464),
        ...
        l = i(70579);
      function t(e) {
        const { handleSubmit: n, handleCancel: i } = e;
        return (0, l.jsxs)(o.A, {
          display: 'flex',
    ...
    63656: (e, n, i) => {
      ...
      function r(e) {
        return (0, t.jsx)(o.A, {
          ...
          variant: 'outlined',
          color: 'secondary',
          startIcon: (0, t.jsx)(l.A, { fontSize: 'large' }),
          sx: { borderRadius: 5 },
    ...
    30604: (e, n, i) => {
      ...
      var o = i(65043),
        s = i(51318),
        l = i(70579);
      const t = { textDecoration: 'none', color: '#551a8b' },
        r = (e) => {
          e.currentTarget.style.color = '#FF7D55';
        },
        a = (0, o.forwardRef)((e, n) => {
          const { to: i, children: o, sx: a } = e;
          return (0, l.jsx)(s.N_, {
            ...e,
            to: i,
            style: { ...t, ...a },
    ...
    49768: (e, n, i) => {
      ...
      function a(e) {
        ...
        return (0, r.jsxs)(l.A, {
          fullWidth: !0,
          children: [
            (0, r.jsx)(o.A, { size: 'small', sx: { mt: a }, children: i }),
            (0, r.jsx)(t.A, {
              size: 'small',
              ...e,
              children: n.map((e, n) =>
                (0, r.jsx)(s.A, { value: e.value, children: e.label }, n)
              )
            })
          ]
        });
    ...
    95851: (e, n, i) => {
      ...
      var o = i(67784),
        s = i(70579);
      const l = (e) => (0, s.jsx)(o.A, { size: 'small', fullWidth: !0, ...e });
    },
    65099: (e, n, i) => {
      i.d(n, { BZ: () => l, XS: () => o, YP: () => t, tR: () => s });
      const o = {
          companyAvatar:
    ...
    82656: (e, n, i) => {
      i.d(n, { C: () => s, c: () => l });
      var o = i(22626);
      const s = new o.A('get-information-company-by-user'),
        l = new o.A('employee/follow-company');
    },
    21430: (e, n, i) => {
      i.d(n, { A: () => m });
      var o = i(19464),
      ...
      function m(e) {
        ...
        return (0, c.jsxs)(l.A, {
          ...
          children: [
            (0, c.jsxs)(o.A, {
              ...
              children: [
                (0, c.jsxs)(o.A, {
                  display: 'flex',
                  children: [
                    (0, c.jsx)(r.A, { color: 'primary', sx: { fontSize: 56 } }),
                    (0, c.jsx)(s.A, {
                      fontWeight: 700,
                      fontSize: 22,
                      lineHeight: 3,
                ...
                (0, c.jsx)(d.A, {
                  to: '/company/'
                    .concat(
                      (0, a.O)(
                        null === m || void 0 === m ? void 0 : m.companyName
                      ),
                      '?id='
                    )
                    .concat(
                      btoa(null === m || void 0 === m ? void 0 : m.userId)
                    ),
                  sx: {
                    textDecoration: 'none',
                    alignItems: 'center',
            ...
            null === (n = x(m)) || void 0 === n
              ? void 0
              : n.map((e, n) => (0, c.jsx)(t.F_, { item: e }, n))
          ]
        });
      }
    },
    55517: (e, n, i) => {
      ...
      const d = () => {
        const e = (0, t.useQueryClient)(),
          { toast: n } = (0, r.n)(),
          { mutate: i, isLoading: o } = (0, t.useMutation)(
            (e) => {
              let [n] = e;
        ...
        return { onFollowJobById: i, isLoading: o };
      };
      var c = i(46783),
        x = i(70579);
      function m(e) {
        ...
        if (
          ...
          return (0, x.jsx)(l.A, {
            ...
            children: (0, x.jsx)(c.A, { isFollow: u })
          });
      }
    },
    98785: (e, n, i) => {
      ...
      function g(e) {
        let { handleFilter: n } = e;
        const {
            control: i,
            reset: c,
            handleSubmit: u,
            formState: { errors: g }
          } = (0, d.mN)({ defaultValues: p }),
          [A, y] = o.useState({}),
          j = (e) => {
            n(e);
          };
    ...
    64188: (e, n, i) => {
      ...
      const S = function (e) {
        var n, i;
        let { job: s } = e;
        const [S, w] = (0, o.useState)(
          (null === s ||
          void 0 === s ||
          null === (n = s.employer) ||
          void 0 === n
            ? void 0
            : n.logo) || y.XS.companyAvatar
        );
        return (0, b.jsxs)(a.A, {
          sx: {
            minHeight: 160,
      ...
      const W = function (e) {
        const {
          ...
          { totalResults: A, refetch: y } = (0, F.A)({ ...p }),
          j = c || 15,
          v = Math.ceil(A / j),
          { jobs: f, refetch: W } = a({ page: u, num: j, ...p });
        return (
          (0, o.useEffect)(() => {
            W(), y();
          }, [p]),
    ...
    2384: (e, n, i) => {
      ...
      const t = (e) => {
        ...
        return {
          jobFollow:
            null === t || void 0 === t || null === (n = t.data) || void 0 === n
              ? void 0
              : n.jobs,
          isLoading: r,
          refetch: a
    ...
    74531: (e, n, i) => {
      ...
      const l = (e) => {
        ...
        const {
          ...
          () => {
            for (const n in e) 'T\u1ea5t c\u1ea3' === e[n] && (e[n] = '');
        ...
        return {
          totalResults:
            null === i || void 0 === i || null === (n = i.data) || void 0 === n
              ? void 0
              : n.totalResults,
          isLoading: l,
          refetch: t
    ...
    70737: (e, n, i) => {
      ...
      const t = () => {
        const e = (0, o.useQueryClient)(),
          { toast: n } = (0, s.n)(),
          i = l.OY.create,
          { mutate: t, isLoading: r } = (0, o.useMutation)(i, {
            onSuccess: (i) => {
              200 === i.status
        ...
        return { onSaveData: t, isLoading: r };
      };
    },
    6897: (e, n, i) => {
      i.d(n, { F_: () => H, Ay: () => Y });
      ...
      const w = () => {
        const e = (0, f.useQueryClient)(),
          { toast: n } = (0, b.n)(),
          i = S.ex.create,
          { mutate: o, isLoading: s } = (0, f.useMutation)(i, {
            onSuccess: (i) => {
              200 === i.status
        ...
        return { onSaveData: o, isLoading: s };
      };
      var C = i(95851),
        F = i(25650),
        I = i(80881),
      ...
      function k(e) {
        ...
        const { isEmployee: i } = (0, b.n)(),
          ...
          { onSaveData: t } = (0, v.A)(),
          {
            ...
            defaultValues: {
              ...s,
              dob: (0, F.vd)(s.dob, 'DD-MM-YYYY', 'DD-MM-YYYY'),
              sex:
                null === (n = A.im.find((e) => e.label === s.sex)) ||
                void 0 === n
                  ? void 0
                  : n.value,
          ...
          children: [
            ...
            (0, T.jsx)(I.A, {
              handleSubmit: a(async (e) => {
                const n = (0, F._g)(e.dob),
                  i = '\u0110\xe3 k\u1ebft h\xf4n' === e.isMarried ? '1' : '0',
                  s = { ...e, dob: n, isMarried: i };
                t(s), (0, W.gV)(s), o();
              }),
              handleCancel: () => o()
            })
      ...
      function L(e) {
        const { close: n, user: i } = e,
          { onSaveData: o } = w(),
          {
            control: s,
            handleSubmit: t,
            formState: { errors: r }
          } = (0, u.mN)({ defaultValues: { ...i } });
        return (0, T.jsxs)(d.A, {
          sx: { p: 3 },
          children: [
            (0, T.jsxs)(l.Ay, {
                ...
                (0, T.jsx)(l.Ay, {
                  ...
                  children: (0, T.jsx)(p.A, {
                    element: (0, T.jsx)(O.A, {
                      ...
                      multiple: !1,
                      defaultValue:
                        null === i || void 0 === i ? void 0 : i.careerField
                    }),
                    control: s,
                    errors: r,
                    fullWidth: !0,
            ...
            (0, T.jsx)(I.A, {
              handleSubmit: t((e) => {
                console.log(e.careerField), o(e), n();
              }),
              handleCancel: () => n()
            })
          ]
          ...
          return (0, T.jsxs)(l.Ay, {
            ...
            children: [
              ...
              'Gi\u1edbi thi\u1ec7u doanh nghi\u1ec7p' === n.label &&
                (0, T.jsxs)(T.Fragment, {
                  children: [
                    (0, T.jsx)(D, { item: !0, xs: 12, children: n.label }),
                    (0, T.jsx)(M, {
                      item: !0,
                      xs: 12,
                      children: (0, T.jsx)(t.A, {
                    ...
                    (0, T.jsx)(r.A, {
                      ...
                      sx: { mx: 'auto' },
                      color: 'secondary',
                      children: i ? 'Thu g\u1ecdn' : '\u0110\u1ecdc th\xeam'
                    })
                  ]
                })
            ]
      ...
      function Y(e) {
        const { user: n, data: i, title: s, editIcon: l, openForm: r } = e,
          [u, h] = (0, o.useState)(!1),
          p = () => {
            h(!1);
          },
          g =
            'User' === r
              ? (0, T.jsx)(k, { close: p, user: n })
              : (0, T.jsx)(L, { close: p, user: n });
        return (0, T.jsxs)(a.A, {
          sx: { paddingX: 2 },
          children: [
            (0, T.jsxs)(d.A, {
            ...
            (0, T.jsx)(d.A, {
              sx: { mt: 1 },
              children: i.map((e, n) => (0, T.jsx)(H, { item: e }, n))
            })
          ]
        });
      }
    ...
    39225: (e, n, i) => {
      ...
      var o = i(61596),
        ...
        h = i(82656);
      const p = (e) => {
        const { data: n, isLoading: i } = (0, u.useQuery)(
      ...
      function b() {
        const [e, n] = (0, A.ok)(),
          i = atob(e.get('id')),
          { state: o } = (0, g.zy)(),
          { company: s, isLoading: r } = p({ employerId: i });
        return (0, y.jsxs)(l.A, {
          maxWidth: 'md',
          sx: { py: 2 },
          children: [
            v(null === s || void 0 === s ? void 0 : s.banner),
            (0, y.jsxs)(a.A, {
              sx: { flex: 1, display: 'flex', alignItems: 'center', px: 5 },
              children: [
                f(null === s || void 0 === s ? void 0 : s.logo),
                (0, y.jsx)(t.A, {
                  variant: 'h3',
                  ml: 2,
                  children: null === s || void 0 === s ? void 0 : s.companyName
                })
              ]
            }),
            (0, y.jsx)(m.A, { company: s }),
            (0, y.jsx)(c.A, {
...
//# sourceMappingURL=9225.21efa1e1.chunk.js.map
